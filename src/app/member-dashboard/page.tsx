...
export default function Page(): JSX.Element {
  ...
  // New state for heart rate
  const [heartRate, setHeartRate] = useState(72);
  const [heartRateHistory, setHeartRateHistory] = useState<number[]>(
    [...Array(12)].map(() => Math.floor(70 + Math.random() * 10))
  );
  ...
  // New effect for heart rate
  useEffect(() => {
    const timer = setInterval(() => {
      const newRate = Math.floor(70 + Math.random() * 10);
      setHeartRate(newRate);
  ...
  const renderMessageContent = () => (
    <div className="bg-white rounded-lg border border-gray-200">
      <div className="grid lg:grid-cols-4 md:grid-cols-3 grid-cols-2 h-[600px]">
        {/* Categories Sidebar */}
        ...
        <div className="p-6">
          {activePage === 'messages' ? (
            ...
            <div className="space-y-8">
              {/* New Grid Layout for Welcome and Messages */}
                ...
                <div className="bg-gradient-to-br from-white to-teal-50/30 rounded-xl border border-gray-200 shadow-lg p-6 relative overflow-hidden">
                  ...
                  <div className="relative space-y-6">
                    ...
                    <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-4">
                      ...
                      <div className="col-span-2 bg-white/60 backdrop-blur-sm p-4 rounded-xl border border-gray-100">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-lg font-semibold text-red-600">120/80</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/60 backdrop-blur-sm p-4 rounded-xl border border-gray-100">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <h3 className="font-semibold text-gray-900">Live Heart Rate</h3>
                            <p className="text-sm text-gray-500">Real-time monitoring</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                      ...
                      <div className="h-32 relative">
                        ...
                        <div className="absolute inset-0 flex items-end">
                          <div className="flex-1 flex items-end h-full gap-1">
                            {heartRateHistory.map((rate, i) => (
                              <div
                                key={i}
                                className="flex-1 bg-gradient-to-t from-red-500/50 to-red-400/50 rounded-sm transition-all duration-300 ease-out"
                                style={{
                                  height: `${((rate - 65) / 20) * 100}%`,
                                  opacity: (i + 5) / heartRateHistory.length
                                }}
                              >
                                <div
                                  className={`w-full h-1 bg-red-500 rounded-full ${
                                    i === heartRateHistory.length - 1 ? 'animate-pulse' : ''
                                  }`}
                                />
                              </div>
                            ))}
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center justify-between p-2 bg-blue-50 rounded-lg">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-sm font-medium text-gray-900">Video Call with Dr. Smith</p>
                        ...
                        <div className="flex items-center justify-between p-2 bg-teal-50 rounded-lg">
                          ...
                          <span className="text-xs font-medium text-teal-600">Reminder Set</span>
                        </div>
                        <div className="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="text-sm font-medium text-gray-900">Evening Walk</p>
                              <p className="text-xs text-gray-500">6:00 PM</p>
                            </div>
                          </div>
                          <span className="text-xs font-medium text-gray-600">Daily Goal</span>
                        </div>
                      </div>
                    </div>
                  </div>
